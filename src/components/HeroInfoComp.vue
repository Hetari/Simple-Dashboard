  ...
  <div class="p-1 w-full bg-[#F8F8F8]">
    <div class="bg-white rounded-lg ml-2 pr-5 pt-4 mt-28 relative z-50">
      ...
      <form class="text-lg ml-3" action="">
        ...
        <div class="grid grid-cols-10">
          <div class="col-span-3 uppercase font-semibold">subtitle</div>
          <div class="col-span-7 mb-5">
            <input
              class="w-full pl-4 h-10 border border-solid rounded-lg"
              type="text"
        ...
        <div class="grid grid-cols-10">
          ...
          <div class="col-span-7 pb-5">
            <input
              class="w-full text-lg rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-100 dark:placeholder-gray-900"
              type="file"
              name="subtitle"
            />
          </div>
        ...
        <div class="flex justify-end">
          <button
            class="bg-[#1c23c0fc] capitalize text-white rounded-md px-8 py-2 mb-5"
          >
            save
          </button>
        </div>
