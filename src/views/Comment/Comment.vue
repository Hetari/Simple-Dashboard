    ...
    <div class="p-1 h-[calc(100vh - 4rem)] w-full bg-[#F8F8F8]">
      <div class="bg-white p-5 mx-2 mt-10 relative z-50 shadow-lg">
        <div class="flex justify-between">
          ...
          <router-link :to="{ name: 'AddComment' }">
            <AddButton />
          </router-link>
        </div>
        <div class="w-full">
          <table class="w-full border-0">
            <thead>
              <tr class="border-y-2">
                <th class="p-2 pl-0 text-start capitalize">check</th>
                <th class="p-2 text-center capitalize">client</th>
                <th class="p-2 text-center capitalize">kind</th>
                <th class="p-2 text-center capitalize">Comment</th>
                <th class="p-2 text-end capitalize">Edit/delete</th>
              </tr>
            </thead>
            <tbody>
              <tr class="border-b">
                <td class="p-2 pl-0 capitalize">
                  <ToggleSwitch />
                </td>
                ...
                <td class="p-2">
                  <div class="flex justify-end">
                    <router-link
                      :to="{ name: 'EditComment', params: { id: 123456789 } }"
                    >
                      <img
